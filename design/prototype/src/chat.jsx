...
function MessageGroup({ beat, agents, playing, onOpenArtifact }) {
    ...
    <div className="rt-rise" style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
      ...
      <div style={{ flex: 1, minWidth: 0,
        ...
        {stage >= 3 && artifactEvs.map((e, i) => {
          const art = window.RT.ARTIFACTS[e.artifactId];
          return art ? <div key={i} style={{ marginTop: i ? 12 : 0 }}>
            <ArtifactRenderer art={art} agents={agents} onOpen={onOpenArtifact} />
          </div> : null;
        })}
...
Object.assign(window, { MessageGroup, ThinkingBlock, WorkingChip, Composer, ConversationRail, LogoMark });
